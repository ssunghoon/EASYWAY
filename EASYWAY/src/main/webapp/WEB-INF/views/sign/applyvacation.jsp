	            ...
	            <div class="easyway-boardapply-form">
					...
					<form class="form-container" action="/sign/applyvacation" method="post" accept-charset="utf-8">
			            ...
			            <div class="form-option1-input">
							...
							<div class="radio-wrapper">
								<input type="radio" name="signVacationType" id="fourth" value="경조사"><label for="fourth">경조사</label>
							</div>
						</div>
			            ...
			            <div class="form-option3-input">
							<!-- 기안 기간 : 작성칸 -->
							<input type="date" name="signVacationStart">
							<input type="date" name="signVacationEnd">
			            </div>
			            <div class="form-file">
			            	<!-- 첨부 파일 -->
