	            ...
	            <div class="easyway-boardapply-form">
		            ...
		            <input type="hidden" name="obId" value="${of_board.obId }">
			            ...
			            <div class="form-title-input">
			                <!-- 제목 : 작성칸 -->
			                <input type="text" class="form-control" name="obTitle"
			                value='<c:out value="${of_board.obTitle }"/>' placeholder="제목을 입력하세요">
			            </div>
						...
						<div class="form-writer-input">
							...
							<input type="hidden" class="form-writer-name" name="employeeId" value="2">
							 </div>
						<div class="form-dep-input">
							<!-- 제목 : 작성칸 -->
							<input type="hidden" class="form-control" name="departmentId" value="2">
						</div>
